...
const googlecast = {
	...
	plyr.remotePlayerController.addEventListener(cast.framework.RemotePlayerEventType.IS_PAUSED_CHANGED, function(e) {
          if (plyr.remotePlayer.isPaused) {
            googlecast.debug.log('Player PAUSED REMOTELY');
          } else {
            googlecast.debug.log('Player UNPAUSED REMOTELY');
          }
        });
	plyr.remotePlayerController.addEventListener(cast.framework.RemotePlayerEventType.CURRENT_TIME_CHANGED, function(e) {
          googlecast.debug.log('Player SEEKED REMOTELY TO '+plyr.remotePlayer.currentTime);
        });
